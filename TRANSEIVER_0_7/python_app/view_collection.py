...
class MainView:
	def __init__(self, parent):
		...
		self.connectionView = None
		self.settingsView = None
		self.addConnectionView = None
		self.messageView = MessageView(tk.TopLevel()) #hiding it
		self.messageView.hide() #maybe just make it automatically hide within the view class
...
class ConnectionView:
	def __init__(self, name, parent, main_view):
		self.name = name
