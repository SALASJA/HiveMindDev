...
class Nrf24{
	public:
		...
		uint8_t RX_ADDR_P_VAL[6][5] = {{'y','0','y'}, //it has to be backwards, this needs to be changed everytime I change the address
                              		   {0,'!','!'},
                               		   {'7','!','!'},
                                       {'8','!','!'},
                                       {'9','!','!'},
		...
		uint8_t * get_RX_address(uint8_t pipe);
		...
		void set_EN_AA_Register(uint8_t value);
		...
		void set_FIFO_STATUS_Register(uint8_t value);
		uint8_t get_FIFO_STATUS_Register();
		
		void set_DYNPD_Register(uint8_t value);
		uint8_t get_DYNPD_Register();
