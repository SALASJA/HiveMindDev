...
do
	...
	/Users/steven.t/downloads/Arduino/Contents/Java/hardware/tools/avr/bin/avrdude -C/Users/steven.t/downloads/Arduino/Contents/Java/hardware/tools/avr/etc/avrdude.conf -v -patmega328p -carduino -P ${currentport[i]} -b115200 -D -Uflash:w:$TX/main.hex:i 
done
